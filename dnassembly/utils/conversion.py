...
def convert_biopython_to_dnassembly(parsed_genbank, output_format):
    ...
    for feature in parsed_genbank.features:
        ...
        # Get feature colors
        #TODO - make these if else statements more readible
...
def convert_dnassembly_to_biopython(dna_entity):
    ...
    dna_as_biopython = SeqRecord(
        seq, 
        id=dna_entity.entity_id,
        name=dna_entity.name,
        features=biopython_feature_list,
        description=dna_entity.description
    )
